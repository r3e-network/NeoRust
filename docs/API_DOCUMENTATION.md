# NeoRust API Documentation (v1.0.8)
> This document reflects the v1.0.8 API surface. For the latest APIs and examples, refer to the root README and current guides.
...
*Generated for NeoRust v1.0.8 - Production Ready*
