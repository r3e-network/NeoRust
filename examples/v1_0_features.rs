//! Example demonstrating new features in NeoRust v1.0.0
//!
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	println!("🚀 NeoRust v1.0.0 Feature Demonstration\n");
	...
	#[cfg(not(feature = "ws"))]
	{
		...
		println!("   Enable with: neo3 = {{ version = \"1.0.0\", features = [\"ws\"] }}");
		println!();
	}
	...
	// ========================================
	println!("✨ Summary");
	println!("   NeoRust v1.0.0 provides:");
