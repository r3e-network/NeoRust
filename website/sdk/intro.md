...
```toml
[dependencies]
neo3 = { version = "1.0.7", features = ["futures", "ledger", "aws"] }
```
...
- **[Performance Guide](https://github.com/R3E-Network/NeoRust/blob/v1.0.7/PERFORMANCE_ANALYSIS.md)**: Optimization techniques
- **[Security Best Practices](https://github.com/R3E-Network/NeoRust/blob/v1.0.7/SECURITY_AUDIT_v1.0.7.md)**: Keep your applications secure
