# Gas Estimation Guide - NeoRust v1.0.1

## Overview

NeoRust v1.0.1 introduces real-time gas estimation using the Neo N3 `invokescript` RPC method, providing accurate fee calculations for transactions before submission. This feature helps optimize costs and prevent transaction failures due to insufficient gas.
...
The gas estimation feature in NeoRust v1.0.1 provides:
