...
> Historical snapshot: this captured the v0.4.1 release readiness. Current SDK is v0.5.4; consult the main README/migration guides for the latest status.
...
**Version**: 0.4.1 (Enhanced Testing Framework & Quality Assurance) — superseded by v0.5.4
