# NeoRust v1.0.0 Release Preparation Guide
> Historical snapshot for the v1.0.0 release; follow main release tooling for future versions.

## 📋 Release Overview

**Version**: 1.0.0  (superseded by v1.0.0)
...
### Breaking Changes
See the migration guide for the documented v1.0.0 breaking changes and required updates.
...
- [x] Version numbers updated (1.0.0) — superseded
