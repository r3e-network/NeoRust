# Migration Guide: Pre-1.0 → v1.0.4

NeoRust v1.0.4 introduces a high-level SDK, WebSockets, HD wallets, and transaction simulation. Core APIs remain, but some helpers were renamed or removed.
...
## Checklist
- Update `Cargo.toml` to `neo3 = "1.0.4"`.
