# NeoRust SDK v1.0.1 Migration Guide

## Overview

This guide provides step-by-step instructions for migrating existing projects from v1.0.0 (or earlier) to v1.0.1. The release focuses on v3.9 alignment improvements, policy iterator helpers, and documentation upgrades while preserving compatibility.
...
Version 1.0.1 maintains backward compatibility with v1.0.0. The only required change is the dependency version bump:

1. **Dependency Version**: Update your Cargo.toml to use v1.0.1
   - Change `neo3 = "1.0.0"` to `neo3 = "1.0.1"` in Cargo.toml
