//! Example demonstrating new features in NeoRust v0.5.5
//!
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	println!("🚀 NeoRust v0.5.5 Feature Demonstration\n");
	...
	#[cfg(not(feature = "ws"))]
	{
		...
		println!("   Enable with: neo3 = {{ version = \"0.5.5\", features = [\"ws\"] }}");
		println!();
	}
	...
	// ========================================
	println!("✨ Summary");
	println!("   NeoRust v0.5.5 provides:");
