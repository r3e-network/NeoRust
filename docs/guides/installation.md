...
```toml
[dependencies]
neo3 = { version = "1.0.5", features = ["futures", "ws", "ledger"] }
```
...
```toml
[dependencies]
neo3 = { version = "1.0.5", features = ["futures", "mock-hsm"] }
```
...
```toml
[dependencies]
neo3 = { version = "1.0.5", features = ["futures", "ws", "ipc", "ledger"] }
```
...
```toml
[dependencies]
neo3 = { version = "1.0.5", default-features = false, features = ["futures"] }
```
