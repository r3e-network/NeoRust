...
> Historical snapshot: this captured the v0.4.1 release readiness. Current SDK is v1.0.0; consult the main README/migration guides for the latest status.
...
**Version**: 0.4.1 (Enhanced Testing Framework & Quality Assurance) — superseded by v1.0.0
