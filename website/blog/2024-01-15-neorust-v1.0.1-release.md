---
slug: neorust-v1.0.1-release
title: 🎉 NeoRust v1.0.1 Released - Production-Ready Neo N3 Development
...
We're excited to announce the release of **NeoRust v1.0.1**, marking a significant milestone in Neo N3 blockchain development with Rust. This release brings enhanced cross-platform compatibility, security improvements, and a completely redesigned developer experience.
...
### Real-World Usage
Teams using NeoRust v1.0.1 report:
...
See our [Migration Guide](https://github.com/R3E-Network/NeoRust/blob/v1.0.1/docs/guides/migration-v1.0.md) for complete details.
...
> "NeoRust v1.0.1 has transformed our development workflow. The type safety and performance improvements are game-changing for our DeFi project."
> 
...
[**Download NeoRust v1.0.1**](../docs/getting-started/installation) and start building today!
