//! Example demonstrating new features in NeoRust v1.0.6
//!
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	println!("🚀 NeoRust v1.0.6 Feature Demonstration\n");
	...
	#[cfg(not(feature = "ws"))]
	{
		...
		println!("   Enable with: neo3 = {{ version = \"1.0.6\", features = [\"ws\"] }}");
		println!();
	}
	...
	// ========================================
	println!("✨ Summary");
	println!("   NeoRust v1.0.6 provides:");
