  ...
  themeConfig:
    ...
    ({
      ...
      metadata: [
        ...
        {name: 'description', content: 'NeoRust v1.0.0 - A production-ready Rust SDK for Neo N3 blockchain development. Build high-performance dApps with type-safe, modern Rust. Optimized and production-ready.'},
      ...
      announcementBar: {
        id: 'v1.0.0-release',
        content:
          '🎉 <strong>NeoRust v1.0.0</strong> is now available! Enhanced performance, optimized code quality, and improved reliability. <a target="_blank" rel="noopener noreferrer" href="https://github.com/R3E-Network/NeoRust/releases/tag/v1.0.0">See what\'s new</a>',
