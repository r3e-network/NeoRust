# Release v1.0.0 - Professional SDK with Enterprise Features 🚀

## Summary
NeoRust v1.0.0 is a major release that transforms the SDK into a professional, complete, and user-friendly blockchain development toolkit. This release delivers enterprise-grade features while maintaining simplicity for beginners.
...
4. **Balance Types**: `sdk::Balance.gas` and `sdk::TokenBalance.amount` now use `DecimalAmount` (exact), and `sdk::TokenBalance.decimals` was removed

## Additional Updates
- Synced embedded `neo_csharp` core/node/vm sources to upstream v3.9.0.
- Added Policy helpers to unwrap iterator results for blocked accounts and whitelisted fee contracts.
- `getversion` now captures RPC settings plus protocol metadata (`standbycommittee`, `seedlist`).
- Hardened HD wallet derivation and improved entropy handling.
- Documentation refresh for HD wallets, transaction simulation, and websocket usage.
...
2. Choose tag: `v1.0.0`
3. Title: `v1.0.0 - Professional SDK with Enterprise Features 🚀`
...
## Links
- [Release Notes](https://github.com/R3E-Network/neo-rust-sdk/releases/tag/v1.0.0)
- [Documentation](https://docs.rs/neo3/1.0.0)
- [Examples](https://github.com/R3E-Network/NeoRust/tree/v1.0.0/examples)
