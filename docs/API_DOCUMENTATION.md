# NeoRust API Documentation (v1.4.0)
> This document reflects the v1.4.0 API surface. For the latest APIs and examples, refer to the root README and current guides.
...
*Generated for NeoRust v1.4.0 - Production Ready*
