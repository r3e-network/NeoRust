...
```toml
[dependencies]
neo3 = { version = "1.4.0", features = ["futures", "ws", "ledger"] }
```
...
```toml
[dependencies]
neo3 = { version = "1.4.0", features = ["futures", "mock-hsm"] }
```
...
```toml
[dependencies]
neo3 = { version = "1.4.0", features = ["futures", "ws", "ipc", "ledger"] }
```
...
```toml
[dependencies]
neo3 = { version = "1.4.0", default-features = false, features = ["futures"] }
```
