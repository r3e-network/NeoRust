                    ...
                    <div className='flex items-center justify-between'>
                      <div>
                        <label className='text-sm font-medium text-gray-700'>
                          Show balance in fiat currency
                        </label>
                        <p className='text-sm text-gray-500'>
                          Display USD equivalent alongside crypto amounts
                        </p>
                      </div>
                      <input
                        type='checkbox'
                        ...
                        onChange={e =>
                          updateSetting('showBalanceInFiat', e.target.checked)
                        }
                  ...
                  <div className='mt-4 space-y-4'>
                    <div className='flex items-center justify-between'>
                      <div>
                        ...
                        <p className='text-sm text-gray-500'>
                          Always ask for password when sending transactions
                        </p>
                      </div>
                      <input
                        type='checkbox'
                    ...
                    <div className='flex items-center justify-between'>
                      <div>
                        ...
                        <p className='text-sm text-gray-500'>
                          Automatically lock wallet when inactive
                        </p>
                      </div>
                      <input
                        type='checkbox'
                        ...
                        onChange={e =>
                          updateSetting('autoLogoutOnIdle', e.target.checked)
                        }
                        className='h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded'
                      />
                    </div>
                  ...
                  <div className='mt-4 space-y-4'>
                    <div>
                      <label className='block text-sm font-medium text-gray-700'>
                        ...
                        {settings.backupReminderInterval} days
                      </label>
                      <input
                        type='range'
                        min='7'
                  ...
                  <div className='mt-4 space-y-4'>
                    <div>
                      ...
                      <select
                        ...
                        onChange={e =>
                          updateSetting('defaultNetwork', e.target.value)
                        }
                        className='mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500'
                      >
                    ...
                    <div className='bg-gray-50 rounded-lg p-4'>
                      <div className='flex items-center'>
                        ...
                        <p className='text-sm text-gray-600'>
                          Custom RPC endpoint management will be available in
                          the next update.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className='mt-4 space-y-4'>
                    <div className='flex items-center justify-between'>
                      ...
                      <input
                        ...
                        onChange={e =>
                          updateSetting('enableDebugMode', e.target.checked)
                        }
                        className='h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded'
                      />
                    </div>
                  ...
                  <div className='mt-4 space-y-4'>
                    <div>
                      ...
                      <input
                        ...
                        onChange={e =>
                          updateSetting('cacheSizeMb', parseInt(e.target.value))
                        }
                        className='mt-1 w-full'
                      />
                      <div className='flex justify-between text-xs text-gray-500 mt-1'>
                    ...
                    <div>
                      <label className='block text-sm font-medium text-gray-700'>
                        ...
                        {settings.maxTransactionHistory}
                      </label>
                      <input
                        type='range'
                        min='100'
